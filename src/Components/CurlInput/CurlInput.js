...
const CurlInput = ({ label = '', onChange, value = '', placeholder = '', onClear = () => null }) => {
  return (
    <div className="flex flex-1 flex-col justify-center items-center">
      ...
      <textarea
        style={{ width: '90%' }}
        className="bg-gray-100 dark:bg-primary-900 resize-none mt-2 h-40 border-2 border-solid border-gray-300 dark:border-gray-700 p-4 rounded text-xs font-mono font-light text-primary-100"
